...
naughty.connect_signal("request::display_error", function(message, startup)
    naughty.notification {
        urgency = "critical",
        title   = "I have died... " .. (startup and "badly... during startup" or "badly"),
        message = message
    }
end)
...
--- | ![TODO] modularize the man page components for each add-on / library to add
--- |         to this menu
local man = {
    page = { quickmenu.term[1] .. ' ' .. 'start batman awesome' },
    site = { quickmenu.browse  }
}
-- Create the default launcher widget and main menu
local upper_menu = {
   { 'hotkeys', function() hotkeys_popup.show_help(nil, awful.screen.focused()) end },
   { 'manpage', quickmenu.term[1] .. ' start man awesome' },
